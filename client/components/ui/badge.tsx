...
const badgeVariants = cva(
  'items-center rounded-full border border-border px-2.5 py-0.5 web:inline-flex web:transition-colors web:focus:outline-none web:focus:ring-2 web:focus:ring-ring web:focus:ring-offset-2',
  {
    variants: {
      variant: {
