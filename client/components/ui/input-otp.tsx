      ...
      {otp.map((pair, rowIndex) => (
        <View key={rowIndex} className="flex-row items-center">
          <TextInput
            ...
            className={cn('h-12 w-12 rounded-l-md border border-input text-center text-primary')}
          />
          <TextInput
            ref={(el) => {
            ...
            className={cn('h-12 w-12 rounded-r-md border border-input text-center text-primary')}
          />
